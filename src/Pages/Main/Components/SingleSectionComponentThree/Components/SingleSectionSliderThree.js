...
import SingleCardCollectionThree from "./SingleCardCollectionThree";

const SingleSectionSliderThree = () => {
  ...
  return (
    <>
      <ThisSingleSection>
        ...
        <SingleMid>
          <SingleMidTop>
            <SingleMidTopLeft>김영감님이 좋아하는 노래</SingleMidTopLeft>
            <SingleMidTopRight>
...
export default SingleSectionSliderThree;
